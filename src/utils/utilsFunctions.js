...
const utils = (() => {
  ...
  const selectEnemies = (scene, enemyName) => {
    ...
    switch (enemyName) {
      case 'demon':
        ...
        break;
      case 'blueSlime1':
        enemy1 = new BattleEnemy(scene, 100, 200, 'blueSlimeBattler', 0, 'Blue Slime', 60, 5, 'blueSlimeDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 300, 'blueSlimeBattler', 0, 'Blue Slime 2', 60, 5, 'blueSlimeDamageAnim', 50, 100);
        enemy3 = new BattleEnemy(scene, 200, 250, 'blueSlimeBattler', 0, 'Blue Slime 3', 60, 5, 'blueSlimeDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        enemies.push(enemy3);
        totalXP = 5;
        ...
        break;
      case 'redSlime1':
        enemy1 = new BattleEnemy(scene, 100, 200, 'redSlimeBattler', 0, 'Red Slime', 80, 10, 'redSlimeDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 300, 'redSlimeBattler', 0, 'Red Slime 2', 80, 10, 'redSlimeDamageAnim', 50, 100);
        enemy3 = new BattleEnemy(scene, 200, 250, 'redSlimeBattler', 0, 'Red Slime 3', 80, 10, 'redSlimeDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        enemies.push(enemy3);
        totalXP = 15;
        ...
        break;
      case 'snake':
        enemy1 = new BattleEnemy(scene, 100, 200, 'snakeBattler', 0, 'Snake', 140, 15, 'snakeDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 300, 'snakeBattler', 0, 'Snake 2', 140, 15, 'snakeDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        totalXP = 15;
        totalMoney = 10;
        ...
        break;
      case 'bee':
        enemy1 = new BattleEnemy(scene, 100, 200, 'beeBattler', 0, 'Bee', 60, 5, 'beeDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 300, 'beeBattler', 0, 'Bee 2', 60, 5, 'beeDamageAnim', 50, 100);
        enemy3 = new BattleEnemy(scene, 200, 250, 'beeBattler', 0, 'Bee 3', 60, 5, 'beeDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        enemies.push(enemy3);
        totalXP = 50;
        ...
        break;
      case 'houseBee':
        enemy1 = new BattleEnemy(scene, 100, 150, 'beeBattler', 0, 'Bee', 60, 5, 'beeDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 250, 'beeBattler', 0, 'Bee 2', 60, 5, 'beeDamageAnim', 50, 100);
        enemy3 = new BattleEnemy(scene, 200, 200, 'beeBattler', 0, 'Bee 3', 60, 5, 'beeDamageAnim', 50, 100);
        enemy4 = new BattleEnemy(scene, 200, 300, 'beeBattler', 0, 'Bee 4', 60, 5, 'beeDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        enemies.push(enemy3);
        enemies.push(enemy4);
      ...
      case 'houseFly':
        enemy1 = new BattleEnemy(scene, 100, 150, 'beeBattler', 0, 'Bee', 60, 5, 'beeDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 250, 'beeBattler', 0, 'Bee 2', 60, 5, 'beeDamageAnim', 50, 100);
        enemy3 = new BattleEnemy(scene, 200, 200, 'flyBattler', 0, 'Fly 1', 100, 10, 'flyDamageAnim', 50, 100);
        enemy4 = new BattleEnemy(scene, 200, 300, 'flyBattler', 0, 'Fly 2', 100, 10, 'flyDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        enemies.push(enemy3);
        enemies.push(enemy4);
        ...
        break;
      case 'schoolSnake':
        enemy1 = new BattleEnemy(scene, 100, 150, 'snakeBattler', 0, 'Snake', 140, 15, 'snakeDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 250, 'snakeBattler', 0, 'Snake 2', 140, 15, 'snakeDamageAnim', 50, 100);
        enemy3 = new BattleEnemy(scene, 200, 200, 'redSlimeBattler', 0, 'Red Slime', 80, 10, 'redSlimeDamageAnim', 50, 100);
        enemy4 = new BattleEnemy(scene, 200, 300, 'redSlimeBattler', 0, 'Red Slime 2', 80, 10, 'redSlimeDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        enemies.push(enemy3);
        enemies.push(enemy4);
        ...
        break;
      case 'schoolPlant':
        enemy1 = new BattleEnemy(scene, 100, 150, 'plantBattler', 0, 'Plant', 200, 20, 'plantDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 250, 'plantBattler', 0, 'Plant 2', 200, 20, 'plantDamageAnim', 50, 100);
        enemy3 = new BattleEnemy(scene, 200, 200, 'flyBattler', 0, 'Fly', 100, 10, 'flyDamageAnim', 50, 100);
        enemy4 = new BattleEnemy(scene, 200, 300, 'flyBattler', 0, 'Fly 2', 100, 10, 'flyDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        enemies.push(enemy3);
        ...
        break;
      case 'schoolRedSlime':
        enemy1 = new BattleEnemy(scene, 100, 150, 'redSlimeBattler', 0, 'Red Slime', 80, 10, 'redSlimeDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 250, 'blueSlimeBattler', 0, 'Blue Slime', 60, 5, 'blueSlimeDamageAnim', 50, 100);
        enemy3 = new BattleEnemy(scene, 200, 200, 'redSlimeBattler', 0, 'Red Slime 2', 80, 10, 'redSlimeDamageAnim', 50, 100);
        enemy4 = new BattleEnemy(scene, 200, 300, 'blueSlimeBattler', 0, 'Blue Slime 2', 60, 5, 'blueSlimeDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        enemies.push(enemy3);
        enemies.push(enemy4);
        ...
        break;
      case 'schoolFly':
        enemy1 = new BattleEnemy(scene, 100, 150, 'flyBattler', 0, 'Fly', 100, 10, 'flyDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 250, 'flyBattler', 0, 'Fly 2', 100, 10, 'flyDamageAnim', 50, 100);
        enemy3 = new BattleEnemy(scene, 200, 200, 'flyBattler', 0, 'Fly 3', 100, 10, 'flyDamageAnim', 50, 100);
        enemy4 = new BattleEnemy(scene, 200, 300, 'flyBattler', 0, 'Fly 4', 100, 10, 'flyDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        enemies.push(enemy3);
        enemies.push(enemy4);
      ...
      case 'schoolBee':
        ...
        break;
      case 'plant':
        enemy1 = new BattleEnemy(scene, 100, 200, 'plantBattler', 0, 'Plant', 200, 20, 'plantDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 300, 'plantBattler', 0, 'Plant 2', 200, 20, 'plantDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        totalXP = 15;
        totalMoney = 12;
        ...
        break;
      case 'fly':
        enemy1 = new BattleEnemy(scene, 100, 200, 'flyBattler', 0, 'Fly', 100, 10, 'flyDamageAnim', 50, 100);
        enemy2 = new BattleEnemy(scene, 100, 300, 'flyBattler', 0, 'Fly 2', 100, 10, 'flyDamageAnim', 50, 100);
        enemies.push(enemy1);
        enemies.push(enemy2);
        totalXP = 10;
        totalMoney = 12;
  ...
  const createActiveChest = (scene, spawnPointX, spawnPointY, texture, animation,
    ...
    const chestLogic = () => {
      ...
      const textBox = createTextBox(scene, mainChar.x - 20, mainChar.y + 20, {
        wrapWidth: 400,
        fixedWidth: 400,
        fixedHeight: 70,
